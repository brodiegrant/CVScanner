...
export async function ingestOnce(opts: {
  ...
  metrics: Metrics;
  // onMessage should quarantine message-level extraction/sync/upload errors
  // internally and return. Throw/reject is reserved for fatal non-message
  // failures; ingestOnce treats thrown errors as hard failures.
